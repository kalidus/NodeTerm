      ...
      setNodes(prevNodes => {
        ...
        if (nodeToEdit) {
          ...
          nodeToEdit.data = {
            ...
            redirectFolders: rdpData.redirectFolders !== false && (rdpData.redirectFolders === true || rdpData.guacEnableDrive !== false),
            ...
            smartSizing: rdpData.smartSizing !== false,
            ...
            guacEnableWallpaper: rdpData.guacEnableWallpaper !== false,
      ...
      setNodes(prevNodes => {
        ...
        if (nodeToEdit) {
          ...
          nodeToEdit.data = {
            ...
            username: vncData.username || '',
            password: vncData.password,
            port: vncData.port || 5900,
            clientType: vncData.clientType || 'web-vnc',
            explicitGuacamole: vncData.clientType === 'guacamole',
          ...
          if (tab.originalKey === originalNode.key && tab.type === 'vnc-guacamole') {
            return {
              ...
              rdpConfig: {
                ...
                password: vncData.password,
                port: vncData.port || 5900,
                resolution: vncData.resolution || '1600x1000',
