...
=======
  ...
  'Catppuccin': {
    ...
    colors: {
      ...
      sidebarText: '#cdd6f4',
      sidebarHover: '#313244',
      sidebarSelected: '#89b4fa',
      sidebarGutter: '#45475a',
      
      menuBarBackground: '#313244',
      menuBarText: '#cdd6f4',
      menuBarBorder: '#45475a',
      menuBarHover: '#45475a',
      
      statusBarBackground: '#89b4fa',
      statusBarText: '#1e1e2e',
      statusBarBorder: '#45475a',
      
      tabBackground: '#313244',
      tabActiveBackground: '#1e1e2e',
      tabHoverBackground: '#45475a',
      tabText: '#cdd6f4',
      tabActiveText: '#94e2d5',
      tabBorder: '#45475a',
      tabCloseHover: '#f38ba8',
      
      tabGroupBackground: '#45475a',
      tabGroupText: '#cdd6f4',
      tabGroupBorder: '#313244',
      
      contentBackground: '#1e1e2e',
      contentBorder: '#45475a',
  ...
  'High Contrast': {
    ...
    colors: {
      ...
      sidebarText: '#ffffff',
      sidebarHover: '#404040',
      sidebarSelected: '#0000ff',
      sidebarGutter: '#808080',
      
      menuBarBackground: '#404040',
      menuBarText: '#ffffff',
      ...
      tabBackground: '#404040',
      tabActiveBackground: '#000000',
      tabHoverBackground: '#808080',
      tabText: '#ffffff',
      tabActiveText: '#00ffff',
      tabBorder: '#808080',
      tabCloseHover: '#ff0000',
      
      tabGroupBackground: '#808080',
      tabGroupText: '#ffffff',
      tabGroupBorder: '#404040',
      
      contentBackground: '#000000',
      contentBorder: '#808080',
