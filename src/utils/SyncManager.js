...
class SyncManager {
  ...
  getAllLocalData() {
    const data = {
      ...
      uiFont: localStorage.getItem('uiFont'),
      uiFontSize: localStorage.getItem('uiFontSize'),
    ...
    const configKeys = [
      ...
      'basicapp_local_linux_terminal_theme', 'uiFont', 'uiFontSize', 'sidebarFont', 'sidebarFontSize', 'sidebarFontColor',
