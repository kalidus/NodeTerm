  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Botón para ocultar/mostrar historial */}
        <button
          onClick={() => setShowHistory(!showHistory)}
          style={{
            position: 'absolute',
            top: '1rem',
            left: showHistory ? '1rem' : '1rem',
            zIndex: 1000,
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.background = themeColors.primaryColor + 'dd';
            e.currentTarget.style.transform = 'scale(1.05)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background = themeColors.primaryColor;
            e.currentTarget.style.transform = 'scale(1)';
          }}
          title={showHistory ? 'Ocultar historial' : 'Mostrar historial'}
        >
          <i className={`pi ${showHistory ? 'pi-eye-slash' : 'pi-eye'}`} style={{ fontSize: '0.9rem' }} />
        </button>
